...
{
    public class EnderecoInstituicaoValidator : AbstractValidator<EnderecoInstituicao>
    {
        public EnderecoInstituicaoValidator()
        {
            RuleFor(x => x)
                .NotEmpty()
            ...
            RuleFor(x => x.Instituicao)
                .NotNull()
                .WithMessage("Instituição não pode ser nulo.")
                .NotEmpty()
                .WithMessage("Instituição não pode ser vazio.");
            ...
            RuleFor(x => x.Cep)
                ...
                .Length(5)
                .WithMessage("O cep deve ter 5 caracteres.");
